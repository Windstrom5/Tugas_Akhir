                ...
                if(role == "Admin"){
                    if(jenis == "Pekerja"){
                        ...
                        if (pekerja?.profile != "null") {
                            val url =
                                "http://192.168.1.5:8000/api/Admin/decryptProfile/${admin?.id}" // Replace with your actual URL
                    ...
                    if(jenis == "Pekerja"){
                        ...
                        if (pekerja?.profile != "null") {
                            val url =
                                "http://192.168.1.5:8000/api/Pekerja/decryptProfile/${admin?.id}" // Replace with your actual URL
