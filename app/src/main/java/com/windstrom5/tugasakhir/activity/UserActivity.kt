...
//            PopupDialog.getInstance(this@PekerjaActivity)
//                .standardDialogBuilder()
//                .createIOSDialog()
//                .setHeading("Logout")
//                .setDescription(
...
//                        sharedPreferencesManager.clearUserData()
//                        startActivity(Intent(this@PekerjaActivity, LoginActivity::class.java))
//                    }
//
//                    override fun onNegativeButtonClicked(dialog: Dialog) {
//                        dialog.dismiss()
...
//        company.setOnTouchListener { _, event ->
//            handleCardTouch(
//                company,
//                event,
//                "CompanyActivity"
...
//            }
    ...
    private fun processWeatherData(response: JSONObject) {
        ...
        val weatherDesc = currentCondition.getJSONArray("weatherDesc").getJSONObject(0).getString("value")
    ...
    private fun getBundle() {
        ...
        if (bundle != null) {
            ...
            val url = "https://selected-jaguar-presently.ngrok-free.app/api/Pekerja/decryptProfile/${pekerja?.id}" // Replace with your actual URL
